...
class TypeRangeTest extends Assertions {
  ...
  def typeRangeOfSingleTypeShouldContainOnlyThatType() {
    ...
    val rangeOfCollectionAny = TypeRange(CTCollectionAny, CTCollectionAny)
    ...
    assertTrue(rangeOfCollectionAny.contains(CTCollectionAny))
  ...
  def unboundedTypeRangeRootedAtAnyShouldContainAll() {
    ...
    assertTrue(rangeRootedAtAny.contains(CTCollectionAny))
  ...
  def unboundedTypeRangeRootedAtBranchTypeShouldContainAllMoreSpecificTypes() {
    ...
    val rangeRootedAtCollectionAny = TypeRange(CTCollectionAny, None)
    ...
    assertTrue(rangeRootedAtCollectionAny.contains(CTCollectionAny))
  ...
  def intersectRangeWithinCollection() {
    val rangeFromCollectionAny = TypeRange(CTCollectionAny, None)
  ...
  def mergeUpWithNestedType() {
    ...
    assertEquals(Seq(TypeRange(CTCollectionAny, CTCollection(CTString)), TypeRange(CTCollection(CTString), None)),
  ...
  def shouldHaveIndefiniteSizeWhenAllowingUnboundAnyAtAnyDepth() {
    ...
    assertFalse(TypeRange(CTCollectionAny, None).hasDefiniteSize)
    ...
    assertFalse(TypeRange(CTCollection(CTCollectionAny), None).hasDefiniteSize)
  ...
  def shouldReparentIntoCollection() {
    ...
    assertEquals(TypeRange(CTCollectionAny, CTCollection(CTNumber)), TypeRange(CTAny, CTNumber).reparent(CTCollection))
  }
}
