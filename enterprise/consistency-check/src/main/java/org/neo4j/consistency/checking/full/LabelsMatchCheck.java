...
public class LabelsMatchCheck implements
        ComparativeRecordChecker<NodeRecord, NodeRecord, ConsistencyReport.LabelsMatchReport>
{
    ...
    @Override
    public void checkReference( NodeRecord record, NodeRecord nodeRecord, CheckerEngine<NodeRecord,
